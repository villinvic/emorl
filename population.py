...
class Individual:
    ...
    def __init__(self, state_shape, action_dim, goal_dim, epsilon=0.01, lr=0.001, gamma=0.98, entropy_scale=0,
...
class LightIndividual:
    def __init__(self, goal_dim, generation=1):
        ...
        self.reward_weight = np.random.uniform(0.0, 1.0, size=(goal_dim,))
        self.behavior_stats = {}
        self.gen = generation
